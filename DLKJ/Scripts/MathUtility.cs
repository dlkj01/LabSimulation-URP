...
namespace DLKJ
{
    ...
    public class MathUtility
    {
        ...
        /// <returns></returns>
        public static float GetCurrentValue(InstrumentButton tempInstrumentBtn)
        {
            //如果开关类按钮 则返回状态值
            if (tempInstrumentBtn.instrumentButtonType == InstrumentButton.InstrumentButtonType.Click || tempInstrumentBtn.instrumentButtonType == InstrumentButton.InstrumentButtonType.Power)
            {
        ...
        {
            return GetCurrentValue(tempInstrumentBtn) * 0.001f;
